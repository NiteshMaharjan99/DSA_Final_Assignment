...
public class Week4 {
    ...
    public static int findTotalContainers(int array[]) {
        // sorting the array
        sortArray(array);
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            // execute else statement if the current element is same as the previous element
            else {
                prevValue = array[i];
                totalContainers += containerForCurrentVillage;
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findTotalContainers(array));
    }
}
